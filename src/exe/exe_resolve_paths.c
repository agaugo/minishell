...
/*   Updated: 2023/12/13 14:28:26 by trstn4        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	ms_set_resolve_error(t_data *data, token_t *current, char **allpath)
{
...
void	ms_resolve_loop(t_data *data, token_t *current, char **allpath)
{
	int	is_command;
