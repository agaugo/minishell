...
token_t			*ms_handle_heredoc(t_data *data, token_t *temp, token_t *first_command_token, int *br2);
token_t			*ms_check_redirects(t_data *data, t_exec_t_data *cmd_data, token_t *next_command);
...
void			remove_empty_token(t_data *data, token_t **prev_token, token_t **current_token);
...
char			*ms_expand_exit_code(t_data *data, char *token_value, int *do_free, int i);
